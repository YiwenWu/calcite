...
public abstract class SqlLibraryOperators {
  ...
  @LibraryOperator(libraries = {POSTGRESQL, BIG_QUERY, SPARK})
  ...
  @LibraryOperator(libraries = {BIG_QUERY, MYSQL, SPARK})
  ...
  @LibraryOperator(libraries = {MYSQL, ORACLE, POSTGRESQL, SPARK})
